...
# import the data
pathData = list(paths.list.images("C:/Users/nadin/Afbeeldingen/data"))                # don't know if you need this or the data splitted like below
...
pathScissors= list(paths.list.images("C:/Users/nadin/Afbeeldingen/data/scissors"))
pathHangLoose= list(paths.list.images("C:/Users/nadin/Afbeeldingen/data/hangloose"))
...
def filter(pathData, limit):                                                           # limit is the number of pixels that are allowed to be different from the median
        print("Median-Filter...")
        filteredImg = np.array(median_filter(pathData, size=limit)).astype(np.float32)
        return filteredImg
